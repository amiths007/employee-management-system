...
import com.employee.management.system.www.service.JwtService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/jwtToken", "/csrf_token", "/get/credentials", "/get/all", "/get/filtered/employees", "/get/employee/*")
                        .permitAll()
